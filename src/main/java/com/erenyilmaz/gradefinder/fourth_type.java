...
public class fourth_type extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fourth_type);
    }
    ...
    public void type1_calculate(View view) {
        ...
        mean = (midterm * percMid) + (final_grade * percFin) + (project * percPro) + (project2 * percPro2);
