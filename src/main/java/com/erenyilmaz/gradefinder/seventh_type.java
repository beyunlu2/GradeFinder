...
public class seventh_type extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_seventh_type);
    }
    ...
    public void type1_calculate(View view) {
        ...
        String sproject2 = ((EditText) findViewById(R.id.Project5)).getText().toString();
        if (TextUtils.isEmpty(sproject2)) {
            ((EditText) findViewById(R.id.Project5)).setError("Please enter a number or decimal");
            return;
        } else
            project2 = Double.parseDouble(sproject2);

        String spercPro2 = ((EditText) findViewById(R.id.ProjectPer5)).getText().toString();
        if (TextUtils.isEmpty(spercPro2)) {
            ((EditText) findViewById(R.id.ProjectPer5)).setError("Please enter a percentile");
            return;
        } else {
        ...
        String sproject=((EditText)findViewById(R.id.Project4)).getText().toString();
        if(TextUtils.isEmpty(sproject)) {
            ((EditText)findViewById(R.id.Project4)).setError("Please enter a number or decimal");
            return;
        }
        else
            project=Double.parseDouble(sproject);

        String spercPro =((EditText)findViewById(R.id.ProjectPer4)).getText().toString();
        if(TextUtils.isEmpty(spercPro)) {
            ((EditText)findViewById(R.id.ProjectPer4)).setError("Please enter a percentile");
            return;
        }
        else {
        ...
        mean = (midterm * percMid) + (final_grade * percFin) + (midterm2 * percMid2) + (project * percPro) + (project2 * percPro2);
