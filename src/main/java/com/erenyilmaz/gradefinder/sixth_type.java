...
public class sixth_type extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sixth_type);
    }
    ...
    public void type1_calculate(View view) {
        ...
        mean = (midterm * percMid) + (final_grade * percFin) + (midterm2 * percMid2) + (project * percPro);
